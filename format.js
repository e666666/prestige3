// Thanks to Antimatter dimensions's creator(s) for providing these awesome number formatting functions
...
function formatValue(value, notation="Scientific", places=2, placesUnder1000=2) {
